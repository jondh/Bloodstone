...
import com.whereone.bloodstone.TextValidate;
...
import com.whereone.bloodstone.users.LogIn;
import com.whereone.bloodstone.users.LogIn.LogInListener;
import com.whereone.bloodstone.users.LogInFacebook;
import com.whereone.bloodstone.users.LogInFacebook.LoginFBListener;
import com.whereone.bloodstone.users.NewUser;
import com.whereone.bloodstone.users.NewUser.NewUserListener;
...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final BloodstoneApplication application = (BloodstoneApplication) this.getApplication();
		mPDialog = new ProgressDialog(this);
		
		SharedPreferences profile = application.getSharedPreferences("com.whereone.profile", Context.MODE_PRIVATE);
