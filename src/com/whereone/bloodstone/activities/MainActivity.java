...
import com.whereone.bloodstone.NavigationDrawerFragment;
...
public class MainActivity extends ActionBarActivity implements
	...
	private BloodstoneApplication application;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		application = (BloodstoneApplication) this.getApplication();
		final DBhttpRequest httpRequest = DBhttpRequest.getInstance();
		profile = Profile.getInstance();
		
		logOut = new LogOutCurrent(httpRequest, profile, application);
		logOutFlag = false;
